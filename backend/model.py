...
#   timestamp: 2022-06-17T23:00:58+00:00
...
class Generics(BaseModel):
    ...
    uranium_price: Optional[int] = None
...
class GLATF(BaseModel):
    exit_multiple: Optional[float] = None
    debt_mix: Optional[float] = None


class BNNLF(BaseModel):
    debt_mix: Optional[float] = None
...
class PBR(BaseModel):
    fcf_multiple: Optional[float] = None


class VET(BaseModel):
    fcf_multiple: Optional[int] = None
...
class Model(BaseModel):
    ...
    DO: Optional[DO] = None
    GLATF: Optional[GLATF] = None
    BNNLF: Optional[BNNLF] = None
    UAN: Optional[UAN] = None
    PBR: Optional[PBR] = None
